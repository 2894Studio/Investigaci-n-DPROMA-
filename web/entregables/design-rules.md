...
| 2.5.4 | 2026-09-22 | Mueve «Qué cambió» de `reglas-de-diseno.html`, de justo debajo del hero a justo antes del historial: con el control de versiones ya al fondo de la página, tenerlo repetido arriba era redundante. De paso se actualiza su contenido, que seguía hablando de "lo nuevo de la 2.4" con la página ya en 2.5.3. Cambio acotado a esta página; no toca la fuente ni la copia descargable, que nunca tuvieron esta sección. |
